...
<div className="sidebar-box">
    ...
    <div className="sidebar-site-1">
        ...
        <Link  className={indexes === 2 ? 'active' : ''} to="/Employerdashbord/Page7" onClick={indexing(2)}>
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
        ...
        <Link  className={indexes === 3 ? 'active' : ''} to="/Employerdashbord/Page9" onClick={indexing(3)}>
